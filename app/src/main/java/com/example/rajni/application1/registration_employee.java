    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                finish();
                Intent i = new Intent(registration_employee.this, login.class);
                startActivity(i);
            }
        });
        Birthdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(registration_employee.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, onDateSetListener, year, month, day);
